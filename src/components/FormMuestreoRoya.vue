<template>
        ...
        <v-card
            ...
            <v-card-title class="title" style="padding:4px;"><v-icon style="padding:10px;">fab fa-pagelines</v-icon>&nbsp; Muestreo de Roya</v-card-title>
        ...
        <v-form v-model="valid_roya" style="padding:5px;">
          <v-tabs dark background-color="blue darken-3" show-arrows>
            <v-tab :href="'#tab-c1'" v-on:click="changeTipoCalculo(0)">Cálculo básico</v-tab>
            <!--<v-tab :href="'#tab-c2'" v-on:click="changeTipoCalculo(1)">Cálculo avanzado</v-tab>-->
            <v-tab-item :value="'tab-c1'">
              <!--<div class="v-card__text" style="background:#007ac1;">-->
                            ...
                            <v-row style="margin-top:10px; height:75px;">
                                <v-col sm="6">
                                    <div class="group"> 
                                        ...
                                        id="hojasTotalesB1"
                                        label="Hojas totales"
                                        v-model.lazy="cp_hojas_totales_b1"
                                ...
                                <v-col sm="6">
                                    <div class="group">
                                        <input
                                        v-model.lazy="cp_hojas_afectadas_b1"
                                        v-lazy-input:debounce="500"
                            ...
                            <v-row style="margin-top:10px;">
                                <v-col sm="6">
                                    <div class="group">
                                        <input
                                        label="Hojas totales"
                                        v-model.lazy="cp_hojas_totales_b2"
                                        v-lazy-input:debounce="500"
                                        color="blue-grey darken-4"
                                        type="number"
                                        v-mask="'###'"
                                ...
                                <v-col sm="6">
                                    <div class="group">
                                        <input
                                        label="Hojas afectadas"
                                        v-model.lazy="cp_hojas_afectadas_b2"
                                        v-lazy-input:debounce="500"
                                        color="blue-grey darken-4"
                                        type="number"
                                        v-mask="'###'"
...
export default {
  ...
  data: () => ({
    ...
    cnplanta: 1,
    cp_hojas_totales_b1: null,
    cp_hojas_afectadas_b1: null,
    cp_hojas_totales_b2: null,
    cp_hojas_afectadas_b2: null
  }),
  computed: {
      errorHTB1 : function(val) {
          return val;
      }
  },
  watch: {},
  methods: {
    ...
    validateHAB1: function() {
        ...
        if(val < 0 || val > 100)
        {
            document.getElementById("valPlanta1").innerHTML = "El valor de hojas totales debe ser mayor o igual que 0 y menor que 100.";
        }
        else if(val > val_) 
        {
            document.getElementById("valPlanta1").innerHTML = "El valor de hojas afectadas no puede ser mayor que las hotas totales.";
        }
        else
        { 
            document.getElementById("valPlanta1").innerHTML = "";
    ...
    validateHTB2: function() {
        ...
        if(val <= 0 || val > 100)
        {
            document.getElementById("valPlanta2").innerHTML = "El valor de hojas totales debe ser mayor que 0 y menor que 100.";
        }
        else
        { 
    ...
    validateHAB2: function() {
        ...
        if(val < 0 || val > 100)
        {
            document.getElementById("valPlanta2").innerHTML = "El valor de hojas afectadas debe ser mayor o igual que 0 y menor que 100.";
        }
        else if(val > val_)
        {
            document.getElementById("valPlanta2").innerHTML = "El valor de hojas afectadas no puede ser mayor que las hojas totales.";
        }
        else
        { 
            document.getElementById("valPlanta2").innerHTML = "";
    ...
    plantaSiguiente: function() {
        ...
        if(this.cp_hojas_totales_b1==='' || isNaN(parseFloat(this.cp_hojas_totales_b1)))
        {
            this.$swal('Evaluación Roya','Debe completar las hojas totales bandola 1.','info');
            this.$refs.hojasTotalesB1.focus();
            return;
        }
        if(this.cp_hojas_totales_b1 * 1 < 1)
        {
            this.$swal('Evaluación Roya','Las hojas totales bandola 1 debe ser un número mayor que 0.','info');
            this.$refs.hojasTotalesB1.focus();
            return;
        }
        if(this.cp_hojas_totales_b1 * 1 > 100)
        {
            this.$swal('Evaluación Roya','El valor máximo de hojas totales bandola 1 es 100','info');
            this.$refs.hojasTotalesB1.focus();
            return;
        }
        if(this.cp_hojas_totales_b2==='' || isNaN(parseFloat(this.cp_hojas_totales_b2)))
        {
            this.$swal('Evaluación Roya','Debe completar las hojas totales bandola 2.','info');
            this.$refs.hojasTotalesB2.focus();
            return;
        }
        if(this.cp_hojas_totales_b2 * 1 < 1)
        {
            this.$swal('Evaluación Roya','Las hojas totales bandola 2 debe ser un número mayor que 0.','info');
            this.$refs.hojasTotalesB2.focus();
            return;
        }
        if(this.cp_hojas_totales_b2 * 1 > 100)
        {
            this.$swal('Evaluación Roya','El valor máximo de hojas totales bandola 2 es 100','info');
            this.$refs.hojasTotalesB2.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b1==='' || isNaN(parseFloat(this.cp_hojas_afectadas_b1)))
        {
            this.$swal('Evaluación Roya','Debe completar las hojas afectadas bandola 1.','info');
            this.$refs.hojasAfectadasB1.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b2==='' || isNaN(parseFloat(this.cp_hojas_afectadas_b2)))
        {
            this.$swal('Evaluación Roya','Debe completar las hojas afectadas bandola 2.','info');
            this.$refs.hojasAfectadasB2.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b1 * 1 < 0)
        {
            this.$swal('Evaluación Roya','Las hojas afectadas bandola 1 debe ser un número mayor que 0.','info');
            this.$refs.hojasAfectadasB1.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b1 * 1 > 100)
        {
            this.$swal('Evaluación Roya','El valor máximo de hojas afectadas bandola 1 es 100','info');
            this.$refs.hojasAfectadasB1.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b2 * 1 < 0)
        {
            this.$swal('Evaluación Roya','Las hojas afectadas bandola 2 debe ser un número mayor que 0.','info');
            this.$refs.hojasAfectadasB2.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b1 * 1 > 100)
        {
            this.$swal('Evaluación Roya','El valor máximo de hojas afectadas bandola 2 es 100','info');
            this.$refs.hojasAfectadasB2.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b1 * 1 > this.cp_hojas_totales_b1 * 1)
        {
            this.$swal('Evaluación Roya','Las hojas afectadas bandola 1 no pueden ser mayor a las totales','info');
            this.$refs.hojasAfectadasB1.focus();
            return;
        }
        if(this.cp_hojas_afectadas_b2 * 1 > this.cp_hojas_totales_b2 * 1)
        {
            this.$swal('Evaluación Roya','Las hojas afectadas bandola 2 no pueden ser mayor a las totales','info');
            this.$refs.hojasAfectadasB2.focus();
            return;
        }
        // ActualizarModelo
    ...
    actualizarModelo:  function(iplanta) {
        ...
        this.muestreo_2bandolas_basico[iplanta].nhojas_b1 = this.cp_hojas_totales_b1 * 1;
        this.muestreo_2bandolas_basico[iplanta].nhojasafectadas_b1 = this.cp_hojas_afectadas_b1 * 1;
        this.muestreo_2bandolas_basico[iplanta].nhojas_b2 = this.cp_hojas_totales_b2 * 1;
        this.muestreo_2bandolas_basico[iplanta].nhojasafectadas_b2 = this.cp_hojas_afectadas_b2 * 1;
    },
    actualizarActual: function(iplanta) {
        this.cp_hojas_totales_b1 = this.muestreo_2bandolas_basico[iplanta].nhojas_b1;
        this.cp_hojas_afectadas_b1 = this.muestreo_2bandolas_basico[iplanta].nhojasafectadas_b1;
        this.cp_hojas_totales_b2 = this.muestreo_2bandolas_basico[iplanta].nhojas_b2;
        this.cp_hojas_afectadas_b2 = this.muestreo_2bandolas_basico[iplanta].nhojasafectadas_b2;
    },
    plantaAnterior: function() {
        // Validar
        if(this.cnplanta - 1 < 1)
        {
            this.$swal('Evaluación Roya','Se encuentra en el inicio de la evaluación.','information');
            return;
        }
        if(this.cp_hojas_totales_b1==='' || isNaN(parseFloat(this.cp_hojas_totales_b1)))
        {
        ...
        try {
            ...
            for(i=0;i<this.nplantas;i++)
            {
                ...
                if(this.muestreo_2bandolas_basico[i].nhojas_b1===null || 
                   this.muestreo_2bandolas_basico[i].nhojas_b1==='' ||
                ...
                if(this.muestreo_2bandolas_basico[i].nhojas_b2===null ||
                   this.muestreo_2bandolas_basico[i].nhojas_b2==='' ||
                ...
                if(this.muestreo_2bandolas_basico[i].nhojasafectadas_b1===null ||
                   this.muestreo_2bandolas_basico[i].nhojasafectadas_b1==='' ||
                   isNaN(parseFloat(this.muestreo_2bandolas_basico[i].nhojasafectadas_b1)))
                {
                    this.$swal('Evaluación Roya',"Favor revisar hojas afectadas bandola 1.","warning");
                    this.actualizarActual(i);
                    this.ncplanta = i + 1;
                    return;
                }
                if(this.muestreo_2bandolas_basico[i].nhojasafectadas_b2===null ||
                   this.muestreo_2bandolas_basico[i].nhojasafectadas_b2==='' ||
                   isNaN(parseFloat(this.muestreo_2bandolas_basico[i].nhojasafectadas_b2)))
                {
                    this.$swal('Evaluación Roya',"Favor revisar hojas afectadas bandola 2.","warning");
                    this.actualizarActual(i);
                    this.ncplanta = i + 1;
                    return;
                }
