<template>
        ...
        <v-card
            ...
            <v-spacer></v-spacer>
                ...
                <v-btn text small v-on:click="saveBroca" v-bind:disabled="btndisabled && (cnplanta!=30)">Calcular</v-btn>
            </v-card-actions>
        </v-card>
                    ...
                    <v-card-text>
                            ...
                            <v-row style="margin-top:10px;">
                                <v-col sm="6">
                                    ...
                                    <label class="inputlabel">Frutos totales</label>
                                    </div>
                                </v-col>
                                <v-col sm="6">
                                    <div class="group">
                                    ...
                                    />
                                    <span class="highlight"></span>
                                    <label class="inputlabel">Frutos perforados</label>
                                    </div>
                                </v-col>
                            </v-row>
                            <v-row>
...
export default {
  ...
  methods: {
    ...
    validateHTB1: function() {
        ...
        if(val <= 0)
        {
            document.getElementById("valPlanta1").innerHTML = "El valor de frutos totales debe ser mayor que 0.";
        }
        else
        { 
    ...
    validateHAB1: function() {
        ...
        if(val < 0)
        {
            document.getElementById("valPlanta1").innerHTML = "El valor de frutos totales debe ser mayor o igual que 0.";
        }
        else if(val > val_) 
        {
            document.getElementById("valPlanta1").innerHTML = "El valor de frutos afectados no puede ser mayor que el de frutos totales.";
        }
        else
        { 
            document.getElementById("valPlanta1").innerHTML = "";
    ...
    validateHTB2: function() {
        ...
        if(val <= 0)
        {
            document.getElementById("valPlanta2").innerHTML = "El valor de frutos totales debe ser mayor que 0.";
        }
        else
        { 
    ...
    validateHAB2: function() {
        ...
        if(val < 0)
        {
            document.getElementById("valPlanta2").innerHTML = "El valor de frutos afectados debe ser mayor o igual que 0.";
        }
        else if(val > val_)
        {
            document.getElementById("valPlanta2").innerHTML = "El valor de frutos afectados no puede ser mayor que los frutos totales.";
        }
        else
        { 
            document.getElementById("valPlanta2").innerHTML = "";
    ...
    plantaSiguiente: function() {
        ...
        if(this.cp_nhojas_b1==='' || isNaN(parseFloat(this.cp_nhojas_b1)))
            ...
            {
                this.$swal('Evaluación Broca','Los frutos totales bandola 1 debe ser un número mayor que 0.','info');
                this.$refs.hojasTotalesB1.focus();
                return;
            }
            ...
            {
                this.$swal('Evaluación Broca','Debe completar los frutos totales bandola 2.','info');
                this.$refs.hojasTotalesB2.focus();
                return;
            }
            if(this.cp_nhojas_b2 * 1 < 1)
            {
                this.$swal('Evaluación Broca','Los frutos totales bandola 2 debe ser un número mayor que 0.','info');
                this.$refs.hojasTotalesB2.focus();
                return;
            }
            ...
            {
                this.$swal('Evaluación Broca','Debe completar los frutos afectados bandola 1.','info');
                this.$refs.hojasAfectadasB1.focus();
                return;
            }
            if(this.cp_nhojasafectadas_b2==='' || isNaN(parseFloat(this.cp_nhojasafectadas_b2)))
            {
                this.$swal('Evaluación Broca','Debe completar los frutos afectados bandola 2.','info');
                this.$refs.hojasAfectadasB2.focus();
                return;
            }
            if(this.cp_nhojasafectadas_b1 * 1 < 0)
            {
                this.$swal('Evaluación Broca','Los frutos afectados bandola 1 debe ser un número mayor que 0.','info');
                this.$refs.hojasAfectadasB1.focus();
                return;
            }
            ...
            {
                this.$swal('Evaluación Broca','Los frutos afectados bandola 2 debe ser un número mayor que 0.','info');
                this.$refs.hojasAfectadasB2.focus();
                return;
            }
            ...
            {
                this.$swal('Evaluación Broca','Los frutos afectados bandola 1 no pueden ser mayor a los totales','info');
                this.$refs.hojasAfectadasB1.focus();
                return;
            }
            if(this.cp_nhojasafectadas_b2 * 1 > this.cp_nhojas_b2 * 1)
            {
                this.$swal('Evaluación Broca','Los frutos afectados bandola 2 no pueden ser mayor a los totales','info');
                this.$refs.hojasAfectadasB2.focus();
                return;
            }
        // ActualizarModelo
    ...
    saveBroca: function() {
        try
        {
            ...
            for(i=0;i<this.nplantas;i++)
            {
                ...
                {
                    this.$swal('Evaluación Broca',"Favor revisar frutos totales bandola 1.","warning");
                ...
                {
                    this.$swal('Evaluación Broca',"Favor revisar frutos totales bandola 2.","warning");
                    this.actualizarActual(i);
                    this.ncplanta = i + 1;
                    return;
                }
                ...
                {
                    this.$swal('Evaluación Broca',"Favor revisar frutos afectados bandola 1.","warning");
                    this.actualizarActual(i);
                    this.ncplanta = i + 1;
                    return;
                }
                ...
                {
                    this.$swal('Evaluación Broca',"Favor revisar frutos afectados bandola 2.","warning");
                    this.actualizarActual(i);
                    this.ncplanta = i + 1;
                    return;
                }
            ...
            if(this.tipocalculo==0)
            {
                if(this.nbandolas==1) {
                    ...
                    var promedioAfectadas = nhojasAfectadasTotales / chojasAfectadas;
                ...
                else
                {
                    for(i=0;i<this.muestreo_seleccionado.length;i++)
                    {
                        ...
                        detalle.push({'detalleEvaluacionPlanta': this.muestreo_seleccionado[i].nplanta,
                                    'detalleEvaluacionBandola':1,
                                    'detalleEvaluacionGranosTotales':this.muestreo_seleccionado[i].nhojas_b1,
                                    'detalleEvaluacionGranosAfectados':this.muestreo_seleccionado[i].nhojasafectadas_b1,
                                    'detalleEvaluacionNsitio':this.muestreo_seleccionado[i].nplanta
                                    });
                        detalle.push({'detalleEvaluacionPlanta': this.muestreo_seleccionado[i].nplanta,
                                    'detalleEvaluacionBandola':2,
                                    'detalleEvaluacionGranosTotales':this.muestreo_seleccionado[i].nhojas_b2,
                                    'detalleEvaluacionGranosAfectados':this.muestreo_seleccionado[i].nhojasafectadas_b2,
                                    'detalleEvaluacionNsitio':this.muestreo_seleccionado[i].nplanta
                                    });
                    }
                    var promedioHojas = nhojasTotales / this.nplantas;
